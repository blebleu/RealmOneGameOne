...
public class HeroPathing
{
    ...
    */
    ...
    Location current;
    readonly Vector2 START = new Vector2(1,1);
    readonly Vector2 TARGET = new Vector2(6,6);
    ...
    public List<Vector2> GetPath(Vector2 startVec) {
        return GetPath(startVec, TARGET);
    }

    public List<Vector2> GetPath(Vector2 startVec, Vector2 targetVec)
    {
